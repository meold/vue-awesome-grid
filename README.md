...
You can find example in `examples/withSummary.html`.

## `extraProps`

Is used to pass additional properties to nested components.
For example, you can pass bus object for events (example in `examples/withNested.html`).
...
You can find example in `examples/withNested.html`.
